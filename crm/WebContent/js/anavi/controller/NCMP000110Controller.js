...
(function (crm_module) {
    ...
    var NCMP000110Controller = (function (_super) {
        __extends(NCMP000110Controller, _super);
        function NCMP000110Controller($scope, $state, ncmp000010Business, userInfo, ncmp000010) {
        ...
        NCMP000110Controller.prototype.init = function () {
            var _this = this;
        ...
        NCMP000110Controller.prototype.createReport = function () {
        };
        NCMP000110Controller.prototype.clear = function () {
            alert("");
        };
        NCMP000110Controller.$inject = ['$scope', '$state', 'NCMP000010Business', 'UserInfo'];
        return NCMP000110Controller;
    }(BaseController));
    crm_module.NCMP000110Controller = NCMP000110Controller;
